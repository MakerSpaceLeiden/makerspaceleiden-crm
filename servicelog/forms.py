...
class ServicelogForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
       ...
       if not self.canreturntoservice:
          self.fields['situation'].choices = [ e for e in self.fields['situation'].choices if e[0] != Servicelog.FIXED]
          self.fields['situation'].help_text = "You cannot mark this machine as `fixed' unless you are able to give instruction on it."
