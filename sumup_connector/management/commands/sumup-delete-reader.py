...
class Command(BaseCommand):
    ...
    def add_arguments(self , parser):
        parser.add_argument('rdr_code' , type=str, 
        help='Specify reader rdr_xxx code to delete')
    ...
    def handle(self, *args, **options):
        ...
        try: 
           print(args)
           res = client.readers.delete_reader(settings.SUMUP_MERCHANT,options['rdr_code'])
           printr(res)
