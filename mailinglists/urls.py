...
urlpatterns = [
    path(
        "mailinglists_edit/<int:user_id>",
        views.mailinglists_edit,
        name="mailinglists_edit",
    ),
    ...
    path(
        "archive/<str:mlist>/<str:yearmonth>/<str:order>.html",
        views.mailinglists_archive,
        name="mailinglists_archive",
    ),
    path(
        "archive/<str:mlist>/<str:yearmonth>.txt.<str:zip>",
        views.mailinglists_archive,
        name="mailinglists_archive",
    ),
    path(
        "archive/<str:mlist>/<str:yearmonth>/",
        views.mailinglists_archive,
        name="mailinglists_archive",
    ),
    path(
        "archive/<str:mlist>/", views.mailinglists_archive, name="mailinglists_archive"
    ),
